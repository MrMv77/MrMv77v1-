...
def banner():
	...
	tap.add_row('Sptty Chan','https://github.com/LORD-XD')
...
def login():
	try:
		...
		try:
			sy = requests.get('https://graph.facebook.com/me?access_Cookie='+cookie)
...
def login_lagi():
	banner()
	sky = '# LOGIN MENGGUNAKAN AKSES Cookie'
	sky2 = mark(sky, style='green')
	sol().print(sky2, style='cyan')
	panda = input(x+'['+p+'f'+x+'] Cookie : ')
	try:
